...
import org.tensorflow.demo.adapters.MainAdapter;
import org.tensorflow.demo.modals.MainListItem;
...
//
//        }
        if(id == R.id.state_agricultural_nav){
...
//
    ...
    else if(id==R.id.plant_disease_id){
        Intent intent = new Intent(MainActivity.this, ClassifierActivity.class);
        startActivity(intent);
        }
        else if(id==R.id.bazaar_rates){
            Intent intent = new Intent(MainActivity.this,BazaarActivity.class);
            startActivity(intent);
        }
